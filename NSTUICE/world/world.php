...
/* //view schedule css */
 ...
 .schedule-card {
    ...
    .white-gap {
      ...
      .schedule-card .btn:not(.btn-edit):not(.btn-update) {
  ...
  color: white;
       ...
       .schedule-card .btn:not(.btn-edit):not(.btn-update) :hover {
...
/* Reuse your edit and update styles if already declared */
.btn-edit {
...
<div class="full-page-layout">
  <div class="layout-body">
    ...
    <div class="sidebar">
      <div class="box">
          <?php include 'view_class_Schedule.php'; ?>
      </div>
...
?>
   ...
   <select id="batch-list" name="batch_privacy" class="form-select form-select-sm mt-2 d-none" style="width: 120px; font-size: 8px; border-radius: 15px;">
    ...
    <div class="sidebar">
      <div class="box">
         <?php include 'exam_updates_view.php'; ?>
      </div>

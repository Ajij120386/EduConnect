...
if (isset($_POST['submit_schedule'])) {
    foreach ($_POST['courses'] as $course) {
        ...
        $sql = "INSERT INTO teacher_class_schedule (teacher_id, teacher_name, course_name, semester, date, start_time, end_time, venue)
        VALUES ('$teacher_id', '$teacher_name', '$name', '$selected_semester', '$class_date', '$start', '$end', '$venue')";

...
<div id="notifWrapper">
  ...
  <span id="notifLabel" style="color: white;  font-weight: 600;
      font-size: 17px; cursor: pointer;">Notifications</span>
...
<?php
    ...
    <a href="custom_search.php">
  <img src="images/searchify_icon.png" class="navbar_img" />
